 ...
 */
export const renderCheckLevel = (value: string | number | null | undefined): VNode | null =>
  renderClassifyTag(value, CHECK_LEVEL_MAP);
...
export const renderCorrectStatus = (value: string | number | null | undefined) =>
...
export const renderCredentialStatus = (value: string | number | null | undefined) =>
...
export const renderQuestionStatus = (value: string | number | null | undefined) =>
...
export function renderDictClassifyTag(
  ...
  return h(ElTag, { type: tagType, size: "small", effect: "plain" }, () => label);
}
...
export const renderCoursewareType = (value: string | number | null | undefined): VNode | null =>
  renderClassifyTag(value, COURSEWARE_TYPE_MAP);
